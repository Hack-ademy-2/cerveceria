  ...
  <nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
      ...
      <li class="sidebar-nav-item">
        <a class="js-scroll-trigger" href="{{route('home')}}">Home</a>
      </li>
      <li class="sidebar-nav-item">
        <a class="js-scroll-trigger" href="{{route('aboutus')}}">About</a>
      </li>
      <li class="sidebar-nav-item">
      ...
      <li class="sidebar-nav-item">
        <a class="js-scroll-trigger" href="{{route('contacts')}}">Contact</a>
      </li>
    </ul>
  </nav>
